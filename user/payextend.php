        ...
        <section>
            <div class="container">
                ...
                <h1 style="text-align: center;color: whitesmoke;">Payment Details</h1>
                    ...
                    $date1 = strtotime($bookRow['returnDate']);
                    $date2 = strtotime($bookRow['extendDate']);
                    $diff = (($date2-$date1)/60)/60/24;
                    $cost = $bookRow['bookExtentedcost']* $diff;
                    echo "<br>"; echo "<br>";    echo "<br>"; 
                    echo "<h2 style='color:white;text-align:center;'>"."Length of Extension:". " ".$diff   ." ". "day(s)</h2>";
                    echo "<h2 style='color:white;text-align:center;'>"."Extension Fee: $". " ".$cost   ."</h2>";
                    echo "<br>"; echo "<br>";    echo "<br>"; echo "<br>";    echo "<br>"; echo "<br>";
                    echo "<h2 style='color:white;text-align:center;'>"."Please return the book by ". " ".$bookRow['extendDate'] ." to avoid extra charges</h2>";



                     ?>
                <br><br><br><h3 style="color:white;text-align:center;"><a href="userviewresource.php"><b>Proceed to payment <i class="fa fa-credit-card" aria-hidden="true"></i></a></h3><br><br>
