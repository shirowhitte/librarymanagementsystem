...
$result=mysqli_query($con,"UPDATE `add_book` SET `bookStatus`='$bookStatus',`extendDate`='$extendDate' WHERE bookId=$id");
header("Location: payextend.php?id=" . $id);
    ...
    <body >
        ...
        <section>
            <div class="container">
                ...
                <h1 style="text-align: center;color: whitesmoke;"><?php $borrow->getExtendInfo($id);?></h1>
                <form action="<?php $_PHP_SELF ?>" method="post">
               

                    <?php $borrow->getExtendDetails($id);?>
                ...
                <br>
                 <button style="float: right;width:30%;" type="submit" name="update" id="update" ><b>Extend Now</b></button>
             </form>
             <br><br><br><br>
                <br>
