    ...
    <body >
        ...
        <section>
            <div class="container">
                ...
                <h3 style="text-align: center;color: whitesmoke;">VIEW ALL RESOURCES</h3>

                 
                <input style="float:right;padding-left: 20px;width:1560px;" type="text" name="search_text" id="search_text" placeholder="Search by Resource Details" class="form-control" /><br><br> 
